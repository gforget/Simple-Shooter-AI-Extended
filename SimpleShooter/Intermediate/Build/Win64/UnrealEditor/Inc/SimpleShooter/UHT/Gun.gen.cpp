...
// End Cross Module References
	...
	DEFINE_FUNCTION(AGun::execFire)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_AIOffsetRadius);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Fire(Z_Param_AIOffsetRadius);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_AGun_Fire_Statics
	{
		struct Gun_eventFire_Parms
		{
			float AIOffsetRadius;
		};
		static const UECodeGen_Private::FFloatPropertyParams NewProp_AIOffsetRadius;
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AGun_Fire_Statics::NewProp_AIOffsetRadius = { "AIOffsetRadius", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Gun_eventFire_Parms, AIOffsetRadius), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AGun_Fire_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AGun_Fire_Statics::NewProp_AIOffsetRadius,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGun_Fire_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Actors/Gun.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGun_Fire_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGun, nullptr, "Fire", nullptr, nullptr, Z_Construct_UFunction_AGun_Fire_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AGun_Fire_Statics::PropPointers), sizeof(Z_Construct_UFunction_AGun_Fire_Statics::Gun_eventFire_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGun_Fire_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGun_Fire_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AGun_Fire_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AGun_Fire_Statics::Gun_eventFire_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AGun_Fire()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AGun_Fire_Statics::FuncParams);
		}
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Gun_eventGetMaxAmmo_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Actors/Gun.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGun, nullptr, "GetMaxAmmo", nullptr, nullptr, Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::PropPointers), sizeof(Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::Gun_eventGetMaxAmmo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::Gun_eventGetMaxAmmo_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AGun_GetMaxAmmo()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AGun_GetMaxAmmo_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_NbRoundsPerShot_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_NbRoundsPerShot;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TimeBetweenRound_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_TimeBetweenRound;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TriggerPulled_MetaData[];
#endif
		static void NewProp_TriggerPulled_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_TriggerPulled;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AGun_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AGun_Fire, "Fire" }, // 274144511
		...
		{ &Z_Construct_UFunction_AGun_GetMaxAmmo, "GetMaxAmmo" }, // 550695462
	};
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGun_Statics::NewProp_NbRoundsPerShot_MetaData[] = {
		{ "Category", "Gun" },
		{ "ModuleRelativePath", "Public/Actors/Gun.h" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AGun_Statics::NewProp_NbRoundsPerShot = { "NbRoundsPerShot", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGun, NbRoundsPerShot), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGun_Statics::NewProp_NbRoundsPerShot_MetaData), Z_Construct_UClass_AGun_Statics::NewProp_NbRoundsPerShot_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGun_Statics::NewProp_TimeBetweenRound_MetaData[] = {
		{ "Category", "Gun" },
		{ "ModuleRelativePath", "Public/Actors/Gun.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGun_Statics::NewProp_TimeBetweenRound = { "TimeBetweenRound", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGun, TimeBetweenRound), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGun_Statics::NewProp_TimeBetweenRound_MetaData), Z_Construct_UClass_AGun_Statics::NewProp_TimeBetweenRound_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGun_Statics::NewProp_TriggerPulled_MetaData[] = {
		{ "ModuleRelativePath", "Public/Actors/Gun.h" },
	};
#endif
	void Z_Construct_UClass_AGun_Statics::NewProp_TriggerPulled_SetBit(void* Obj)
	{
		((AGun*)Obj)->TriggerPulled = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AGun_Statics::NewProp_TriggerPulled = { "TriggerPulled", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AGun), &Z_Construct_UClass_AGun_Statics::NewProp_TriggerPulled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGun_Statics::NewProp_TriggerPulled_MetaData), Z_Construct_UClass_AGun_Statics::NewProp_TriggerPulled_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGun_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGun_Statics::NewProp_NbRoundsPerShot,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGun_Statics::NewProp_TimeBetweenRound,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGun_Statics::NewProp_BaseOffsetRadius,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGun_Statics::NewProp_TriggerPulled,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Gabriel_Unreal_Project_SimpleShooterAIExtendedGit_SimpleShooter_Source_SimpleShooter_Public_Actors_Gun_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGun, AGun::StaticClass, TEXT("AGun"), &Z_Registration_Info_UClass_AGun, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGun), 3489794487U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Gabriel_Unreal_Project_SimpleShooterAIExtendedGit_SimpleShooter_Source_SimpleShooter_Public_Actors_Gun_h_3574030176(TEXT("/Script/SimpleShooter"),
