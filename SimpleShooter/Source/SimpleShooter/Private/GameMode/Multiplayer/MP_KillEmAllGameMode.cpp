...
void AMP_KillEmAllGameMode::OnPostLogin(AController* NewPlayer)
{
	...
	if (UMainGameInstance* GameInstance = Cast<UMainGameInstance>(GetGameInstance()))
	{
		...
		{
			NewPlayer->Possess(ShooterCharacter);
		}
	}
}

void AMP_KillEmAllGameMode::Logout(AController* Exiting)
{
	Super::Logout(Exiting);
}

void AMP_KillEmAllGameMode::FillSpawningPoints()
{
